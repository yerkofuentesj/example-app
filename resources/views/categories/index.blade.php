    ...
    <div>
      ...
      <div class="row py-1">
        <div class="col-md-9 d-flex align-items-center">
          <a class="d-flex align-center gap-2" href="{{ route('categories.show', ['category' => $category->id]) }}">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title" id="exampleModalLabel">Eliminar categoria</h1>
            ...
            <div class="modal-footer">
              ...
              <form action="{{ route('categories.destroy',['category' => $category->id]) }}" method="POST">
                @method('DELETE')
                @csrf
                <button type="button" class="btn btn-danger">Si, eliminar categoria</button>
              </form>
            </div>
          </div>
        </div>
